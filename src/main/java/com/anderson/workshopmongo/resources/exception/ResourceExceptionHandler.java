package com.anderson.workshopmongo.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotException e, HttpServletRequest request){
